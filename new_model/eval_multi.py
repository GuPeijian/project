...
model_path="./weibo_output_no_bow/"
...
text_id=tokenizer.encode(input_text7,max_length=300,truncation=True,add_special_tokens=True)

user_id= [tokenizer.convert_tokens_to_ids('<user1>'), tokenizer.convert_tokens_to_ids('<user2>')]
input_ids=text_id+[user_id[0]]
...
for i in range(times):
    a=model.generate(input_ids,topp=0.96,no_repeat_ngram_size=3,do_sample=True,max_length=(text_len+50),min_length=(text_len+7),
