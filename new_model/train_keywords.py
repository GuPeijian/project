...
def main():
    ...
    # data and model
    parser.add_argument("--data_path", default="/home/gpj/project/all_data/keywords/all_data.json", type=str, )
    parser.add_argument("--model_name_or_path", default='/home/gpj/bert-chinese', type=str, )
    parser.add_argument("--output_dir", default="/home/gpj/project/all_model/keywords_model_raw", type=str, )
    ...
    parser.add_argument("--log_dir", default="/home/gpj/project/log/keyword_model_raw", type=str, )
    ...
    SPECIAL_TOKENS_DICT = {'additional_special_tokens': ["<user1>", "<user2>","<keywords>"]}
