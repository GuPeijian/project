...
def main():
    ...
    #data and model
    parser.add_argument("--data_path",default='/home/gpj/transformers/new_model/1stage_comment/tokenized_data.json',type=str,)
    parser.add_argument("--model_name_or_path",default='/home/gpj/bert-chinese',type=str,)
    parser.add_argument("--output_dir",default='./sentiment_output',type=str,)
    ...
    train_dataloader = DataLoader(train_dataset,num_workers=2,batch_size=args.batch_size, shuffle=False, drop_last=True, collate_fn=padding_unilm_fn,sampler=train_sampler)

    model = UniLMModel.from_pretrained(args.model_name_or_path)
