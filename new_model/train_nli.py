...
def main():
    ...
    # data and model
    parser.add_argument("--data_path", default='/home/gpj/project/all_data/nli_data/nli_data.txt', type=str, )
    parser.add_argument("--model_name_or_path", default="/home/gpj/bert-chinese", type=str, )
    parser.add_argument("--output_dir", default='/home/gpj/project/all_model/nli_from_scratch', type=str, )
    ...
    parser.add_argument("--log_dir", default="/home/gpj/project/log/nli_from_scratch", type=str, )
